...
<!-- single-service.php 04:55  --><head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/favicon.ico" />
    <title>Connext Coin Hub - Bitcoin And Crypto Currency  </title>
    <!-- Bootstrap core CSS -->
			...
			<div class="row">
					...
					<div class="widget cat_wid mb-5">
						...
						<div class="widget-inner mt-5">
							<div class="category-menu">
								<ul>
									<li><a href="#">Bitcoin & Ethereum <i class="float-right icofont icofont-thin-right"></i></a></li>
									<li><a href="#" class="active">Cryptocurrency Trading <i class="float-right icofont icofont-thin-right"></i></a></li>
									<li><a href="#">Bitcoin Trading <i class="float-right icofont icofont-thin-right"></i></a></li>
									<li><a href="#">Coin Buy & Sell <i class="float-right icofont icofont-thin-right"></i></a></li>
									<li><a href="#">Account Security <i class="float-right icofont icofont-thin-right"></i></a></li>
									<li><a href="#">Bitcoin Legality <i class="float-right icofont icofont-thin-right"></i></a></li>
									<li><a href="#">Trading Strategy <i class="float-right icofont icofont-thin-right"></i></a></li>
									<li><a href="#">Money Exchange <i class="float-right icofont icofont-thin-right"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
					<!-- end widget -->
					<div class="widget bo_wid mb-5">
						<h3 class="widget-title">Download Boucher</h3>
						<!-- end widget tittle-->
						<div class="widget-inner mt-5">
							<div class="category-menu">
								<ul>
									<li><a href="#">Document One.ppt <i class="float-right icofont icofont-file-powerpoint"></i></a></li>
									<li><a href="#">Document Two.doc <i class="float-right icofont icofont-law-document"></i></a></li>
									<li><a href="#">Document Three.txt <i class="float-right icofont icofont-file-text"></i></a></li>
									<li><a href="#">Document Four.pdf <i class="float-right icofont icofont-file-pdf"></i></a></li>
								</ul>
							</div>
						</div>
					</div>
					<!-- end widget -->	
					<div class="widget tes_wid">
						<h3 class="widget-title">Clinet Feebback</h3>
						<!-- end widget tittle-->
						<div class="widget-inner mt-5 text-center">
				...
				<div class="col-lg-8 col-md-8 col-12">
						...
						<div class="row">
							 <div class="col-12 pr-0 mb-2">
								<div id="tabsJustifiedContent" class="tab-content">
									<div id="one" class="tab-pane animated fadeInUp active show">
										<a href="assets/img/service/3.jpg" data-title="IMAGE TITLE 1" class="venobox info vbox-item" data-gall="galma"><img class="img-fluid" src="assets/img/service/3.jpg" alt=""></a>	
									</div>
									<div id="two" class="tab-pane animated fadeInUp">
									...
									<div id="three" class="tab-pane animated fadeInUp">
										<a href="assets/img/service/1.jpg" data-title="IMAGE TITLE 3" class="venobox info vbox-item" data-gall="galma"><img class="img-fluid" src="assets/img/service/1.jpg" alt=""></a>
									</div>
								</div>
							</div>
							 <div class="col-12">
								 <ul id="tabsJustified" class="nav nav-tabs text-center">
									<li class="col-lg-2 col-md-4 col-4 nav-item">
					...
					<div class="row mt-4">
						...
						<!-- end col -->
						<div class="row">
							<div class="col-lg-6 col-md-6 col-12 mb-lg-0 mb-md-0 mb-4 pl-4 ser-page-into">
								<ul>
						...
						<div class="row">
							<div class="col-12">
								<ul class="nav nav-tabs" role="tablist">
									<li class="nav-item"><a class="nav-link active" href="#" data-target="#srone" data-toggle="tab">Description</a></li>
									<li class="nav-item"><a class="nav-link" href="#" data-target="#srtwo" data-toggle="tab">Experinece</a></li>
									<li class="nav-item"><a class="nav-link" href="#" data-target="#srthree" data-toggle="tab">Values</a></li>
								</ul>
								<!-- Tab panes -->
								<div class="tab-content">
									<div class="tab-pane animated fadeInRight active show" id="srone">
										<div class="row">
											<div class="col-lg-5 col-md-5 col-12 mb-lg-0 mb-md-0 mb-sm-3 mb-3">
									...
									<div class="tab-pane animated fadeInRight" id="srtwo">
										<div class="row">
											<div class="col-lg-7 col-md-7 col-12 mt-4 mb-lg-0 mb-md-0 mb-sm-3 mb-3">
									...
									<div class="tab-pane animated fadeInRight" id="srthree">
