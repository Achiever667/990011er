						...
						<div class="col-lg-4 col-md-4 col-12 mb-4">
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="#"><h4>Bitmain Antminer E3(180mh)</h4></a>
										<p class="price">$400.00-$450.00</p>
										<p class="rating">
											<i class="icofont icofont-ui-rating"></i>
											<i class="icofont icofont-ui-rate-blank"></i>
											<i class="icofont icofont-ui-rating"></i>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4">
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="#"><h4>Innosilicon T2 Turbo Miner</h4></a>
										<p class="price">$300.00-$350.00</p>
										<p class="rating">
											<i class="icofont icofont-ui-rating"></i>
											<i class="icofont icofont-ui-rate-blank"></i>
											<i class="icofont icofont-ui-rating"></i>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4">
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="#"><h4>AntMiner S5 ASIC Bitcoin Miner </h4></a>
										<p class="price">$500.00-$650.00</p>
										<p class="rating">
											<i class="icofont icofont-ui-rating"></i>
											<i class="icofont icofont-ui-rating"></i>
											<i class="icofont icofont-ui-rating"></i>
						...
						<div class="col-lg-4 col-md-4 col-12 mb-4">
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="#"><h4>Innosilicon S11 Blake2b SiaMaster</h4></a>
										<p class="price">$400.00-$500.00</p>
										<p class="rating">
											<i class="icofont icofont-ui-rating"></i>
											<i class="icofont icofont-ui-rating"></i>
											<i class="icofont icofont-ui-rate-blank"></i>
						...
						<div class="col-lg-4 col-md-4 col-12">
							<div class="single-shop-wrapper">
								<div class="single-shop">
									...
									<div class="single-shop-meta">
										<a href="#"><h4>Aluminum USB Hub for Mining</h4></a>
										<p class="price">$330.00-$400.00</p>
										<p class="rating">
											<i class="icofont icofont-ui-rating"></i>
											<i class="icofont icofont-ui-rating"></i>
											<i class="icofont icofont-ui-rating"></i>
