		...
		<div class="logo-area">
			<div class="auto-container">
				<div class="row">
					...
					<!-- <h2 class="bitcoin ml-auto text-right">Bitcoin <i class="fab fa-btc"></i></h2> -->
			...
			<div class="row">
				<div class="col-12 text-center">
					<div class="section-title">
						<h5>why buy & sell</h5>
						<h3>Connext Coin Hub <span>Features</span></h3>
					</div>
				</div>
			</div>
			<!-- end section title -->
    ...
    <section id="pricetable" class="section-padding">
        <div class="container">
			<div class="row">
				<div class="col-12 text-center">
					<div class="section-title">
						<h5>Connext Coin Hub conversation</h5>
				...
				<div class="col-lg-6 col-md-6 col-12 pr-lg-5 pr-md-5 pr-sm-0 pr-0 mb-lg-0 mb-md-4 mb-sm-4 mb-4">
					...
					<div class="youtube-promo-video-wrap">
						...
						<div class="youtube-promo-video">
							<a href="https://www.youtube.com/watch?v=OTewW0jWRQM" data-title="Connext Coin Hub PROMO VIDEO" data-vbtype="youtube" class="venobox info vbox-item" data-gall="gallu">
    ...
    <section id="price" class="section-padding bg-gray">
        <div class="container">
			<div class="row">
				<div class="col-12 text-center">
					<div class="section-title">
						<h5>Connext Coin Hub packages</h5>
