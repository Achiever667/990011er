				...
				<div class="row">
					<div class="col-12 text-center">
						<ol class="breadcrumb">
							...
							<li class="breadcrumb-item active">Single Team</li>
						</ol>
					</div>
				</div>
				<!-- end row-->
        ...
        <div class="container">	 
			<div class="row">
				<div class="col-lg-8 col-md-8 col-sm-12 col-12 mb-lg-0 mb-md-0 mb-5">
					<div class="row">	
						<div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-lg-0 mb-md-0 mb-4">
						...
						<div class="col-lg-8 Col-md-8 col-sm-12 col-12">
							...
							<div class="steam-details-info mt-3 mb-3">
								<p><i class="icofont icofont-pin"></i> 10004, Battery Park, New York, USA </p>
								<p><i class="icofont icofont-phone"></i> 123-456-0975</p>
								<p><i class="icofont icofont-envelope"></i> info@yoursite.com</p>
								<p><i class="icofont icofont-web"></i> www.your_site.com</p>
							</div>
							<div class="steam-details-social">
								<ul>
						...
						<div class="row">
							<div class="col-lg-12">
								<ul class="nav nav-tabs" role="tablist">
									...
									<li class="nav-item"><a class="nav-link" href="#" data-target="#two" data-toggle="tab">Experinece</a></li>
									<li class="nav-item"><a class="nav-link" href="#" data-target="#three" data-toggle="tab">Education</a></li>
								</ul>
								<!-- Tab panes -->
				...
				<aside class="col-lg-4 col-md-4 col-sm-12 col-12 pl-lg-5 pl-md-5 pl-sm-2 pl-2">
					<div class="widget search_wid mb-5">
						<h3 class="widget-title">Quick Contact</h3>
						<!-- end widget tittle-->
						<div class="widget-inner mt-5">
							<div class="steam-details-form">
								<form action="#">
									<div class="row">
										<div class="form-group col-12 mb-3">
											<input name="sname" class="form-control" id="sfirst-name" placeholder="Name" required="required" type="text">
										</div>
										<div class="form-group col-lg-6 mb-3">
											<input name="semail" class="form-control" id="semail" placeholder="Email" required="required" type="email">
										</div>
										<div class="form-group col-lg-6 mb-3">
											<input name="ssubject" class="form-control" id="ssubject" placeholder="Subject" required="required" type="text">
										</div>									
										<div class="form-group col-lg-12 mb-3">
											<textarea rows="6" name="smessage" class="form-control" id="sdescription" placeholder="Your Message Here..." required="required"></textarea>
										</div>
					...
					<div class="widget search_wid">
						<h3 class="widget-title">Team List</h3>
						<!-- end widget tittle-->
						<div class="widget-inner mt-5">
							<div class="steam-list">
								<div class="steam-list-single">
									<img src="assets/img/team/person1.jpg" alt="" class="img-fluid">
									<h6 class="steam-list-title">Mark Henry</h6>
									<p>Hash Theme,CEO</p>
								</div>
								<div class="steam-list-single">
									<img src="assets/img/team/person2.jpg" alt="" class="img-fluid">
									<h6 class="steam-list-title">Bishen Ketty</h6>
									<p>Hash Theme,CEO</p>
								</div>
								<div class="steam-list-single">
									<img src="assets/img/team/person1.jpg" alt="" class="img-fluid">
									<h6 class="steam-list-title">Jhon Doe</h6>
									<p>Hash Theme,CEO</p>
								</div>
							</div>
						</div>
