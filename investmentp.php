  ...
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      <div class="main-content">
        ...
        <h2 class="pd-4">Investment Plans</h2>
          <div class="row ">
                    ...
                    <div class="row ">
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                        <div class="card-content">
                          ...
                          <p class="mb-0"><span class="col-green">6%</span> Increase for each Referral <span><a href="invest.php"><button class="form-control button col-purple">Refer</button></a></span></p>
                        </div>
                      </div>
                      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                        <div class="banner-img">
