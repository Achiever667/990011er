					...
					<div class="row">
						<div class="col-lg-9 d-none d-lg-block d-md-none">
							<nav class="navbar navbar-expand-lg bg-transparent justify-content-left">
								<ul class="navbar-nav">
								   <li class="home"><a href="index.html" class="active nav-link"><i class="icofont icofont-home"></i>Home</a>
										</li>
									<li class="sevices"><a href="service.html" class="nav-link"><i class="icofont icofont-worker"></i>Services</a>
									</li>
									<li class="News"><a href="blog.html" class="nav-link"><i class="icofont icofont-news"></i>News<a>
									</li>
									<li><a href="contact.html" class="nav-link"><i class="icofont icofont-ui-contact-list"></i>Contact</a></li>
									<li class="dropdown"><a class="nav-link" href="about.html"><i class="icofont icofont-people"></i>About Us</a>
